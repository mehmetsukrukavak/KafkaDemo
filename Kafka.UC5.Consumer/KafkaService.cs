...
using Kafka.UC5.Consumer.Events;


namespace Kafka.UC5.Consumer;

internal static class KafkaService
{
    internal static async Task ConsumeMessageFromSpecificPartitionAndAfterSpecificOffsetAsync(string topicName)
    {
        var config = new ConsumerConfig()
        {
            BootstrapServers = "localhost:9094",
            GroupId = "use-case-4-consumer-specificoffset-group-1",

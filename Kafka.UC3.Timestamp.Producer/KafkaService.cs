...
using Kafka.UC3.Timestamp.Producer.Events;


namespace Kafka.UC3.Timestamp.Producer;
...
internal static class KafkaService
{
    ...
    internal static async Task SendComplexMessageWithComplexKeyAndHeaderAndTimestampAsync(string topicName)
    {
